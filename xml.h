...
namespace Approach::Render {
		...
		public:
				...
				explicit XML(const std::string &_tag)
				noexcept: tag(_tag) { XML::SetRenderID(); }

				XML(const std::string &_tag, const std::string &_id)
				noexcept: tag(_tag), id(_id) { XML::SetRenderID(); }

				XML(const std::string &_tag, const std::string &_id,
						std::vector<std::string> &_classes)
				noexcept: tag(_tag), id(_id), classes(_classes) { XML::SetRenderID(); }

				XML(const std::string &_tag, const std::string &_id,
						std::vector<std::string> &_classes,
						std::map<std::string, std::string> &_attributes)
				noexcept: tag(_tag), id(_id), classes(_classes), attributes(_attributes) {
				 XML::SetRenderID();
				}

				explicit XML(std::string &_tag)
				noexcept: tag(_tag) { XML::SetRenderID(); }
				...
				XML(std::string _tag, std::map<ProcUnit, void *> options)
				noexcept: tag(std::move(_tag)) {
				 XML::SetRenderID();
				 SetOptions(options);
				}
				...
				noexcept: tag(_tag), id(_id), classes(_classes) {
				 XML::SetRenderID();
				 SetOptions(options);
				}
				...
				void RenderHead(std::ostream &stream) override {
				 ...
				 if (!this->content.empty())
					stream << std::endl << this->content << std::endl;
				}
